...
# 4. Invoice Payment Notifications {#notification}
...
Notifications handler server URL is specified in <a href="https://p2p.qiwi.com/">p2p.qiwi.com</a> in **Protocol settings** section.
...
Personalization allows you to create a payment form with your style, customizable logo, background and color of the buttons.  You can create styles in your account on [p2p.qiwi.com](https://p2p.qiwi.com), when setting up codeStyle. 
